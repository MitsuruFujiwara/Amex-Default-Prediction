...
sub_path = '../output/submission_cb_agg_mean.csv'
oof_path = '../output/oof_cb_agg_mean.csv'

model_path = '../models/cb_agg_mean_'

imp_path_png = '../imp/cb_importances_agg_mean.png'
imp_path_csv = '../imp/feature_importance_cb_agg_mean.csv'
