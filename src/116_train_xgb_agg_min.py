...
sub_path = '../output/submission_xgb_agg_min.csv'
oof_path = '../output/oof_xgb_agg_min.csv'

model_path = '../models/xgb_agg_min_'

imp_path_png = '../imp/xgb_importances_agg_min.png'
imp_path_csv = '../imp/feature_importance_xgb_agg_min.csv'
