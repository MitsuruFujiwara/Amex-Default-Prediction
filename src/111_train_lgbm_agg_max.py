...
#==============================================================================
# Train LightGBM max only
#==============================================================================

warnings.filterwarnings('ignore')

configs = json.load(open('../configs/105_lgbm_agg_max.json'))

feats_path = '../feats/f005_*.feather'

sub_path = '../output/submission_lgbm_agg_max.csv'
oof_path = '../output/oof_lgbm_agg_max.csv'

model_path = '../models/lgbm_agg_max_'

imp_path_png = '../imp/lgbm_importances_agg_max.png'
imp_path_csv = '../imp/feature_importance_lgbm_agg_max.csv'
