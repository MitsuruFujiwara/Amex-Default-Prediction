...
sub_path = '../output/submission_xgb_agg_mean.csv'
oof_path = '../output/oof_xgb_agg_mean.csv'

model_path = '../models/xgb_agg_mean_'

imp_path_png = '../imp/xgb_importances_agg_mean.png'
imp_path_csv = '../imp/feature_importance_xgb_agg_mean.csv'
