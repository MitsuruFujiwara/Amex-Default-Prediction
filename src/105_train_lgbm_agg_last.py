...
sub_path = '../output/submission_lgbm_agg_last.csv'
oof_path = '../output/oof_lgbm_agg_last.csv'

model_path = '../models/lgbm_agg_last_'

imp_path_png = '../imp/lgbm_importances_agg_last.png'
imp_path_csv = '../imp/feature_importance_lgbm_agg_last.csv'
